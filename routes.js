...
module.exports = (app, allModels) => {
  ...
  app.get(
    '/blitt/friendList/:friend_id',
    userControllerCallbacks.getFriendBills
  );
  app.post(
    '/blitt/friendList/:friend_id/settleByUser',
    userControllerCallbacks.settleByUser
  );
  app.get('/blitt/groupList/:id', groupControllerCallbacks.singleGroup);
  app.get(
    '/blitt/groupList/:id/chooseWhoToSettleInGroup',
    groupControllerCallbacks.chooseSettleByGroup
  );
  app.get('/blitt/groupList/:id/newBill', billControllerCallbacks.newBill);
  app.get(
    '/blitt/groupList/:id/group_profile',
    groupControllerCallbacks.groupProfile
  );
  app.post(
    '/blitt/groupList/:id/groupProfilePost',
    upload.single('myFile'),
    groupControllerCallbacks.groupProfilePost
  );
  app.post(
    '/blitt/groupList/:id/addInBill',
    billControllerCallbacks.newBillPost
  );
  app.post(
    '/blitt/groupList/:group_id/chooseWhoToSettleInGroup/:settler_id',
    billControllerCallbacks.settleGroupBill
  );
  app.get('/blitt/groupList/:id/:billId', billControllerCallbacks.singleBill);

  app.get(
    '/blitt/groupList/:id/:billId/editBill',
    billControllerCallbacks.editBill
  );
  app.post(
    '/blitt/groupList/:id/:billId/editBill',
    billControllerCallbacks.editBillPost
  );
  app.post(
    '/blitt/groupList/:id/:billId/deleteBill',
    billControllerCallbacks.deleteBill
  );
  app.get('/blitt/user_profile', userControllerCallbacks.userProfile);
  app.get(
    '/blitt/user_profile/edit_profile',
    userControllerCallbacks.editProfile
  );
  app.post(
    '/blitt/user_profile/edit_profile',
    userControllerCallbacks.editProfilePost
  );
  app.get(
    '/blitt/user_profile/change_password',
    userControllerCallbacks.changePassword
  );
  app.post(
    '/blitt/user_profile/change_password',
    userControllerCallbacks.changePasswordPost
  );
  app.post(
    '/blitt/user_profile/postProfilePic',
    upload.single('myFile'),
    userControllerCallbacks.postProfilePic
  );
