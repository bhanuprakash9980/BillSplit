            ...
            if(x.group_id===null){
                ...
                return <div class="card  mb-3 activity-card-modifier">
                  ...
                  <div class="card-body activity-card-body-modifier">
                    ...
                    <p class="card-text activity-card-text-modifier"><span>{persona}</span> {x.category} owings with {secondPersona} worth ₹{x.amount}</p>
                  </div>
                </div>
            }else{
                let persona = "";
                ...
                return <div class="card  mb-3 activity-card-modifier">
                  ...
                  <div class="card-body activity-card-body-modifier">
                    ...
                    <p class="card-text activity-card-text-modifier"><span>{persona}</span> {x.category} owings with {secondPersona} in <span className="activity-strong-text">"<a href={url}>{x.activity}</a>"</span> group worth ₹{x.amount}</p>
                  </div>
                </div>
            }
