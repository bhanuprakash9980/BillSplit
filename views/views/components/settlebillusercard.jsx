...
class SettleBillUserCard extends React.Component {
  render() {
    ...
    let text = net>0? <p className="settle-bill-detail-net" style={{color:"red"}}>You owe ₹{net}</p> : <p className="settle-bill-detail-net" style={{color:"green"}}>Owes you ₹{net*-1}</p>

    let modaltext = net>0? <span style={{color:"red"}}>₹{net}</span> : <span style={{color:"green"}}>₹{net*-1}</span>
