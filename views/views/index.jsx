        ...
        <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
            ...
            <div class="tab-content tab-modifier" id="myTabContent">
                ...
                <div class="card border-success mb-3 profile-card-modifier" style={{width: "230px"}}>
                    ...
                    <div class="card-body">
                        <p class="card-text">₹ {this.props.totalExpenses.toFixed(2)}</p>
                    </div>
                </div>
                <div class="card border-secondary mb-3 profile-card-modifier" style={{width: "230px"}}>
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text" style={{color:"#ff7751"}}>₹ {this.props.totalBorrowed.toFixed(2)}</p>
                    </div>
                </div>
                <div class="card border-info mb-3 profile-card-modifier" style={{width: "230px"}}>
                    ...
                    <p class="card-text" style={{color:"#55cc9d"}}>₹ {this.props.totalLent.toFixed(2)}</p>
                    </div>
                </div>
                </div>
